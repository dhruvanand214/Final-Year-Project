 ...
 **/
var Layout = (function () {
  var layoutImgPath = "img/dashboard.php";

  var layoutCssPath = "css/dashboard.php";
  ...
  var handleSidebarAndContentHeight = function () {
    ...
    if (
      ...
      body.hasClass("sidemenu-container-fixed") === false
    ) {
  ...
  var handleSidebarMenuActiveLink = function (mode, el) {
    ...
    if (mode === "click") {
      if (
        ...
        $(".sidemenu-container").hasClass("in")
      ) {
  ...
  var handleSidebarMenu = function () {
    ...
    $(".sidemenu").on(
      ...
      function (e) {
        ...
        if (
          App.getViewPort().width >= resBreakpointMd &&
          !$(".sidemenu").attr("data-initialized") &&
          $("body").hasClass("sidemenu-closed") &&
          that.parent("li").parent(".sidemenu").length === 1
        ) {
          return;
        }
        ...
        if (
          App.getViewPort().width >= resBreakpointMd &&
          that.parents(".sidemenu-hover-submenu").length === 1
        ) {
    ...
    $(".sidemenu-container .sidebar-search").on(
      "keypress",
      "input.form-control",
      function (e) {
        if (e.which == 13) {
  ...
  var _calculateFixedSidebarViewportHeight = function () {
    var sidebarHeight =
      App.getViewPort().height - $(".page-header").outerHeight(true);
  ...
  var handleFixedSidebar = function () {
    ...
    if (
      App.getViewPort().width >= resBreakpointMd &&
      !$("body").hasClass("sidemenu-not-fixed")
    ) {
    ...
    $(".full-height-content").each(function () {
      ...
      if (target.hasClass("portlet")) {
        ...
        height =
          ...
          parseInt(target.find(".portlet-body").css("padding-bottom"), 10) -
          5;
    ...
    loadAjaxContent: function (url, sidebarMenuLink) {
      ...
      $.ajax({
        ...
        success: function (res) {
          ...
          if (
            sidebarMenuLink.length > 0 &&
            sidebarMenuLink.parents("li.open").length === 0
          ) {
