    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <a href="edit_gfg.php" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-primary" style="margin-top: 9rem !important;">Edit</a>
                    <div class="club_content">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if (in_array($filecheck, $fileextstored)) {
                                ...
                                $q = "INSERT INTO `event`(`Name`, `Banner`, `Winner`, `Link`, `Date`) VALUES ('$username', '$destinationfile', '$winner', '$link', '$date')";
