				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Study Material</div>
							</div>
							...
							<div class="card-head">
								...
								<div class="card-body ">
									...
									<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle table-responsive" id="myTable">
										...
										<?php
                                                include('db.php');
                                                $selectquery = "select * from study_material";
											...
											<tr class="odd">
												...
												<td><a href="./<?php echo $res['Data'] ?>">See Document</a></td>
												
												<td><a href="<?php echo $res['Link'] ?>">Click</a></td>
												...
												<?php
                                                        ...
                                                        ?>
                                                            ...
                                                            <td>
                                                                <a href="edit_study_material.php?id4=<?php echo $res['S.no'] ?>" class="tblEditBtn">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a href="delete_study_material.php?id4=<?php echo $res['S.no'] ?>" class="tblDelBtn">
...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/light/all_study_material.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Dec 2022 06:34:36 GMT -->
</html>