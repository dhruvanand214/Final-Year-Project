...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/light/add_study_material.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Dec 2022 06:34:36 GMT -->
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Add Study Material</div>
							</div>
								...
								<form action="" method="post" enctype="multipart/form-data">
									...
									<!-- <div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" id="txtFirstName" name="no">
											<label class="mdl-textfield__label">S.No.</label>
										</div>
									</div> -->
										<div class="col-lg-6 p-t-20">
										...
										<div class="col-lg-6 p-t-20">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" type="text" id="txtTitle" name="subject">
										...
										<div class="col-lg-6 p-t-20">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" type="text" id="text" name="year">
												<label class="mdl-textfield__label">Year</label>
											</div>
										</div>
										<div class="col-lg-6 p-t-20">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" type="text" id="txtPrice" name="link">
										...
										<div class="col-lg-6 p-t-20">
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
												<input class="mdl-textfield__input" type="file" id="file" name="data">
												<label class="mdl-textfield__label" style="top: 0;">Data</label>
											</div>
										</div>

										<div class="col-lg-12 p-t-20">
											<div class="mdl-textfield mdl-js-textfield txt-full-width">
												<input class="mdl-textfield__input" rows="4" id="text7" name="material">
												<label class="mdl-textfield__label" for="text7">Material Details</label>
											</div>
										</div>
...
if (isset($_POST['submit'])) {
	...
	$folder = "studymaterial/" . $filename;

	$insertquery = "INSERT INTO `study_material`(`Title`, `Subject`, `Year`, `Data`, `Link`, `Detail`) VALUES ('$title','$subject','$year','$folder','$link', '$material')";
