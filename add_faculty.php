							...
							<div class="card-box">
								...
								<!-- <div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text" id="txtFirstName" name="facno">
											<label class="mdl-textfield__label">Faculty No.</label>
										</div>
									</div> -->
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtFirstName" name="designation">
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<label class="mdl-textfield__label">Year of Joining</label>
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="experience">
											<label class="mdl-textfield__label">Experience</label>
										</div>
									</div>
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="qual">
											<label class="mdl-textfield__label">Qualification</label>
										</div>
									</div>
...
if(isset($_POST['submit'])){
    ...
    $insertquery = "INSERT INTO `faculty`(`Name`, `Email`, `Number`, `Designation`, `Gender`, `Qualifications`, `Experience`, `Joining_Year`) VALUES ('$name','$email','$mobno','$designation','$gender','$qual','$experience','$date')";
