                        ...
                        <div class="col-sm-12">
                            <div class="card-box">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    $showquery = "select * from study_material where `S.no` = {$id4}";
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $query = "UPDATE `study_material` SET `S.no`='$no',Title`='$title',`Subject`='$subject',`Year`='$year',`Data`='$data',`Link`='$link' WHERE S.no = $idupdate";

                                        // $query = "UPDATE `faculty` SET `Fac_no`='$facno',`Name`='$name',`Email`='$email',`Number`='$mobno',`Designation`='$designation',`Gender`='$gender',`Qualifications`='$qual',`Experience`='$experience',`Joining_Year`='$date' WHERE Fac_no = $idupdate";
                                    ...
                                    <div class="card-body row">
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" id="txtFirstName" name="no" value="<?php echo $arraydata['S.no']; ?>">

                                            </div>
                                        </div>
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" id="txtTitle" name="title" value="<?php echo $arraydata['Title']; ?>">

                                            </div>
                                        </div>
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" id="txtTitle" name="subject" value="<?php echo $arraydata['Subject']; ?>">
                                        ...
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" id="text" name="year" value="<?php echo $arraydata['Year']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" id="txtPrice" name="link" value="<?php echo $arraydata['Link']; ?>">
                                            </div>
                                        </div>

                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="file" id="file" name="data" value="./<?php echo $arraydata['Data']; ?>">
                                            </div>
                                        </div>

                                        <div class="col-lg-12 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield txt-full-width">
                                                <input class="mdl-textfield__input" rows="4" id="text7" name="material" value="<?php echo $arraydata['Detail']; ?>">
                                            </div>
                                        </div>
