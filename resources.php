...
<head>
    ...
    <link href="assets/css/coding.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css" />
</head>
<!-- END HEAD -->
                        ...
                        <div class="courses-container">
                            <div class="ag-format-container">
                                <div class="ag-courses_box">
                                    ...
                                    include('db.php');
                                    $selectquery = "select * from resources";
                                    $query = mysqli_query($con, $selectquery);
                                    $nums = mysqli_num_rows($query);

                                    
                                    $colors = ['#f9b234', '#3ecd5e', '#e44002', '#952aff', '#cd3e94', '#4c49ea'];

                                    while ($res = mysqli_fetch_array($query)) {

                                        
                                        $randomIndex = array_rand($colors); // Generate a random index from the colors array
                                        $bgColor = $colors[$randomIndex];
                                    ?>

                                        <div class="ag-courses_item">
                                            <a href="<?php echo $res['link']; ?>" class="ag-courses-item_link">
                                                <div class="ag-courses-item_bg" style="background-color: <?php echo $bgColor; ?>;"></div>
                                                ...
                                                <div class="ag-courses-item_date-box">
                                                    Language :
                                                    <span class="ag-courses-item_date" style="color: <?php echo $bgColor; ?>;">
