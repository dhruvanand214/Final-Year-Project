                                    ...
                                    <div class="card-body row">
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" id="txtFirstName" name="subid">
                                                <label class="mdl-textfield__label">Subject ID</label>
                                            </div>
                                        </div>

                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input class="mdl-textfield__input" type="text" id="txtRollNo" name="subname">
...
if (isset($_POST['submit'])) {
    ...
    $insertquery = "INSERT INTO `subjects`(`subject_id`, `subject_name`) VALUES ('$subid','$subname')";
    $insertquery2 = "INSERT INTO `year_subjects`(`year_id`, `subject_id`) VALUES ('$yearId','$subid')";
