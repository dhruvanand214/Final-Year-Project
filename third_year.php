...
<!-- Mirrored from www.einfosoft.com/templates/admin/smart/source/light/all_students.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 17 Dec 2022 06:34:34 GMT -->
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Third Year Students List</div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle table-responsive" id="myTable">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                include('db.php');
                                                $selectquery = "select * from students where Passing_year = (DATE_FORMAT(CURDATE(), '%Y')+1)";
                                                ...
                                                ?>
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        ?>
                                                            ...
                                                            <td>
                                                                <a href="edit_second.php?id=<?php echo $res['Roll_No'] ?>" class="tblEditBtn">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                <a href="delete_second.php?id=<?php echo $res['Roll_No'] ?>" class="tblDelBtn">
