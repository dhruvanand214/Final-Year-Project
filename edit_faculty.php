...
$showquery = "select * from faculty where `S.no` = {$id2}";
...
if (isset($_POST['submit'])) {
	...
	// $insertquery = "INSERT INTO `students_second`(`Roll_No`, `Name`, `Section`, `Mobile`, `Email`, `Col_ID`, `DOB`, `Par_No`) VALUES ('$rollno','$name','$section','$mobno','$email','$collid','$dob','$parno')" `Fac_no`='$facno',;

	$query = "UPDATE `faculty` SET `Name`='$name',`Email`='$email',`Number`='$mobno',`Designation`='$designation',`Gender`='$gender',`Qualifications`='$qual',`Experience`='$experience',`Joining_Year`='$date' WHERE `S.no` = $idupdate";
...
?>
									...
									<div class="col-lg-6 p-t-20">
										<div
											...
											<input class="mdl-textfield__input" type="text"
												pattern="-?[0-9]*(\.[0-9]+)?" id="text5" name="mob_no" value="<?php echo $arraydata['Number']; ?>">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="txtFirstName" name="designation" value="<?php echo $arraydata['Designation']; ?>">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" id="date" name="date" value="<?php echo $arraydata['Joining_Year']; ?>">
										</div>
									</div>
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
											<input class="mdl-textfield__input" type="text" id="list2" value="<?php echo $arraydata['Gender']; ?>" readonly
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="experience" value="<?php echo $arraydata['Experience']; ?>">
										</div>
									</div>
									...
									<div class="col-lg-6 p-t-20">
										<div
											class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
											<input class="mdl-textfield__input" type="text" name="qual" value="<?php echo $arraydata['Qualifications']; ?>">
										</div>
									</div>
									...
									<a href="all_faculty.php"><button type="button"
											class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-danger">All Faculty</button></a>
									</div>
								</div>
                                </form>
							</div>
