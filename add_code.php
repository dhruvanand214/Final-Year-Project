                                        ...
                                        <div class="col-lg-12 p-t-20">
                                            ...
                                            <div class="col-lg-6 p-t-20">
                                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                    <input class="mdl-textfield__input" type="text" name="heading">
                                                    <label class="mdl-textfield__label">Heading</label>
                                                </div>
                                            </div>

                                            <div class="mdl-textfield mdl-js-textfield txt-full-width">
                                                <input class="mdl-textfield__input" rows="4" id="text7" name="description">
...
if (isset($_POST['submit'])) {
    ...
    $insertquery = "INSERT INTO `coding`(`Heading`, `Discription`, `Prob_link`) VALUES ('$heading','$description','$link')";
