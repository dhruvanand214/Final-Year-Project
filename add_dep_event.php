                ...
                <div class="page-content">
                    <div class="card-body edit-body row">
                        ...
                        <div class="col-lg-12 p-t-20 text-center">
                            ...
                            <button type="button"
											class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-circle btn-danger" >xzs</button>
                        </div>
                        </form>
                    </div>
                </div>
...
if (isset($_POST['submit'])) {
    ...
    if (in_array($filecheck, $fileextstored)) {
        ...
        $q = "INSERT INTO `dep_event`(`Name`, `Banner`, `Winner`, `Link`, `Date`, `LDTR`) VALUES ('$username', '$destinationfile', '$winner', '$link', '$date', '$ldtr')";
