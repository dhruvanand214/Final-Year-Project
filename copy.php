                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                                <input class="mdl-textfield__input" type="text" id="list2" value="" readonly tabIndex="-1" name="year">
                                        ...
                                        <!-- <div class="col-lg-12 p-t-20 text-center">
                                            <input type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect m-b-10 m-r-20 btn-circle btn-primary" name="next" value="Next">
                                        ...
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                                ...
                                                // Retrieve the subject names for the given year name
                                                $stmt = $con->prepare("SELECT s.subject_id, s.subject_name FROM subjects s INNER JOIN year_subjects ys ON s.subject_id = ys.subject_id INNER JOIN years y ON ys.year_id = y.year_id WHERE y.year_name = '$yearName'");
                                                //$stmt->bind_param("s", $yearName);
                                                $stmt->execute();
                                                $result = $stmt->get_result();

                                                echo '<input class="mdl-textfield__input" type="text" id="list3" value="" readonly tabIndex="-1" name="subject">
                                                <label for="list3" class="pull-right margin-0">
                                                    <i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
                                                </label>
                                                <label for="list3" class="mdl-textfield__label">Select Subject</label>
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo '<li class="mdl-menu__item" value=' . $subjectId . '>' . $subjectName . '</li>';
                                                }
                                                // echo '</select>';
                                                echo '</ul>';
...
if (isset($_POST['submit'])) {
    ...
    $insertquery = "INSERT INTO `marks`(`Roll_No`, `subject_id`, `marks_obtained`) VALUES ('$rollno','$subjectId','$marks')";
...
<?php
        while ($row = $result->fetch_assoc()) {
          ...
          $subjectName = $row['subject_name'];
        ?>
          <li class="mdl-menu__item" data-val="<?php echo $subjectId; ?>"><?php echo $subjectName; ?></li>
        <?php
        }
        ?>
...
include('db.php');
// Get the logged-in student's Roll_no from the login process
session_start();
...
$query = "SELECT m.mark_id, m.Roll_No, m.subject_id, m.marks_obtained
          FROM marks m
          INNER JOIN students s ON m.Roll_No = s.Roll_No
          WHERE s.Roll_No = '$loggedInRollNo'";
...
if ($result) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<li>Mark ID: $markId | Subject ID: $subjectId | Marks Obtained: $marksObtained</li>";
        }
        echo "</ul>";
    } else {
...
<!-- <div class="col-lg-6 p-t-20">
                                        ...
                                        <div class="col-lg-6 p-t-20">
                                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                                <input class="mdl-textfield__input" type="text" id="list1" value="<?php echo $arraydata['year_name']; ?>" readonly tabIndex="-1" name="year">
                                                <label for="list1" class="pull-right margin-0">
                                                    <i class="mdl-icon-toggle__label material-icons">keyboard_arrow_down</i>
                                                </label>
                                                <label for="list1" class="mdl-textfield__label">Year</label>
